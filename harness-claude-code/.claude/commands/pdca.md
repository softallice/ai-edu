...
단일 PDCA 단계를 실행합니다. `@.claude/skills/pdca/SKILL.md`의 흐름·게이트·에이전트 매핑을 따릅니다.
...
4. **종료 시 `.pdca-status.json` 파일에 상태를 갱신**한다 (currentPhase, gates, iterationCount, generatedFiles).
