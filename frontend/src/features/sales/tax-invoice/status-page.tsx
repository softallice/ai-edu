...
export function TaxInvoiceStatusPage() {
  const now = new Date()
        ...
        <div className='flex flex-wrap items-end justify-between gap-2'>
          ...
          <div className='flex items-end gap-2'>
            <SelectDropdown
              defaultValue='ALL'
              onValueChange={(v) =>
                setStatus(v === 'ALL' ? undefined : (v as TaxInvoiceStatus))
              }
              placeholder='상태'
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className='w-28'>계약</TableHead>
              ...
              {isLoading ? (
                ...
                list.map((t) => (
                  <TableRow key={t.id}>
                    ...
                    <TableCell>{t.contractCode ?? '-'}</TableCell>
