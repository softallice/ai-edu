...
export function ExternalEduApplyPage() {
    ...
    <>
      ...
      <Main className='flex flex-1 flex-col gap-4'>
        <div className='flex flex-wrap items-end justify-between gap-2'>
          <div>
            <h2 className='text-2xl font-bold tracking-tight'>사외교육신청</h2>
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className='w-40'>교육기관</TableHead>
                <TableHead className='w-52'>기간</TableHead>
                <TableHead className='w-28 text-end'>교육비(원)</TableHead>
